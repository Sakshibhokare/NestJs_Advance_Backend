...
**********************************************************
providers in modules are those classes made using Injectable
we have to add our service file to module so we can use in other modules 
...
we will import entire UserModule into the postModule, but it doesnt mean that everything will be accessible, only the service will be accessible 
@Module({
...
**********************************************************************
create authmodule along with service and controller 
nest generate module auth 
nest generate controller auth --no-spec 
nest generate service auth/providers/auth --flat --no-spec // this for generating service at specific location 

*********************************************************************
for Circular dependency injection we need to use forwardRef function in service as well as in module 
