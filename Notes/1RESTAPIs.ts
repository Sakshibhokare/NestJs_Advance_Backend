// REST full form: Representational state transafer 

// principles of REST APIs:
// 1. Client server decoupling : this means there is no other relation between client and server, it is completely decoupled 
